...
The first parameter must be analyzable as **literals** in the AST.
...
Describe the route in its [rule](/compiler/files), and add the file to a component:
